...
t.removeClass("l-btn-small l-btn-medium l-btn-large").addClass("l-btn-"+_9a.size).addClass(_9a.areaCls);
if(_9a.plain){
...
},beforePageText:"第",afterPageText:"页    共{pages}页",displayMsg:"当前显示{from}-{to}条数据,共{total}条数据",nav:{first:{iconCls:"pagination-first",handler:function(){
...
_2d1=_2d1||{};
var opts=$.extend({},{title:"",minHeight:0,content:undefined,msg:"",text:undefined,interval:600},_2d1);
...
var m=$(e.target).closest("div.mymenu,div.combo-p");
if(m.length){
return;
}
$("body>div.mymenu-top:visible").not(".mymenu-inline").menu("hide");
_420($("body>div.mymenu:visible").not(".mymenu-inline"));
});
});
function init(_421){
var opts=$.data(_421,"menu").options;
$(_421).addClass("mymenu-top");
...
menu.addClass("menu");
_425.push(menu);
if(!menu.hasClass("mymenu-content")){
...
$("<div class=\"mymenu-line\"></div>").prependTo(menu);
}
_42a(_428,menu);
if(!menu.hasClass("mymenu-inline")){
menu.hide();
}
_42b(_428,menu);
};
...
if(_42e.separator){
item.addClass("mymenu-sep");
}
if(!item.hasClass("mymenu-sep")){
item.addClass("mymenu-item");
item.empty().append($("<div class=\"mymenu-text\"></div>").html(_42e.text));
if(_42e.iconCls){
$("<div class=\"mymenu-icon\"></div>").addClass(_42e.iconCls).appendTo(item);
}
if(_42e.id){
...
if(item[0].submenu){
$("<div class=\"mymenu-rightarrow\"></div>").appendTo(item);
}
}
};
...
menu.find(".mymenu-item").each(function(){
$(this)._outerHeight(opts.itemHeight);
$(this).find(".mymenu-text").css({height:(opts.itemHeight-2)+"px",lineHeight:(opts.itemHeight-2)+"px"});
});
menu.removeClass("mymenu-noline").addClass(opts.noline?"mymenu-noline":"");
var _433=menu.data("menu").options;
var _434=_433.width;
var _435=_433.height;
if(isNaN(parseInt(_434))){
_434=0;
menu.find("div.mymenu-text").each(function(){
...
_435=_436;
if(menu.hasClass("mymenu-top")&&opts.alignTo){
var at=$(opts.alignTo);
...
menu.children("div.mymenu-line")._outerHeight(_436-2);
if(!_432){
menu.hide();
}
};
...
var item=$(e.target).closest(".mymenu-item");
if(item.length){
...
item.addClass("mymenu-active");
if(item.hasClass("mymenu-item-disabled")){
item.addClass("mymenu-active-disabled");
return;
}
...
var item=$(e.target).closest(".mymenu-item");
if(item.length){
item.removeClass("mymenu-active mymenu-active-disabled");
...
item.removeClass("mymenu-active");
}
}
};
function _446(e){
...
if(!menu[0].shadow){
menu[0].shadow=$("<div class=\"mymenu-shadow\"></div>").insertAfter(menu);
}
menu[0].shadow.css({display:(menu.hasClass("mymenu-inline")?"none":"block"),zIndex:$.fn.menu.defaults.zIndex++,left:menu.css("left"),top:menu.css("top"),width:menu.outerWidth(),height:menu.outerHeight()});
...
if(menu&&menu.length){
_452(menu);
menu.find("div.mymenu-item").each(function(){
if(this.submenu){
_420(this.submenu);
}
$(this).removeClass("menu-active");
...
function find(menu){
menu.children("div.mymenu-item").each(function(){
...
var t=$(_458);
if(t.hasClass("mymenu-item")){
var opts=t.data("menuitem").options;
opts.disabled=_459;
if(_459){
t.addClass("mymenu-item-disabled");
t[0].onclick=null;
}else{
t.removeClass("mymenu-item-disabled");
...
$("<div class=\"mymenu-rightarrow\"></div>").appendTo(_45c.parent);
_427(_45b,_45d);
}
...
function _461(el){
if(el.submenu){
el.submenu.children("div.mymenu-item").each(function(){
_461(this);
});
...
function _467(_468){
$(_468).children("div.mymenu-item").each(function(){
_45e(_468,this);
});
if(_468.shadow){
_468.shadow.remove();
...
item.text=_46c.text;
$(_46c.target).children("div.mymenu-text").html(_46c.text);
});
},setIcon:function(jq,_46d){
return jq.each(function(){
var item=$(_46d.target).data("menuitem").options;
item.iconCls=_46d.iconCls;
$(_46d.target).children("div.mymenu-icon").remove();
if(_46d.iconCls){
$("<div class=\"mymenu-icon\"></div>").addClass(_46d.iconCls).appendTo(_46d.target);
}
});
...
function _5ad(){
if(_5a9.menu){
var item=_5a9.menu.children("div.mymenu-item:first");
_5a9.menu.children("div.mymenu-item").each(function(){
...
if(t.find(".calendar-mymenu").is(":visible")){
_609(_607);
}
};
function init(_60a){
$(_60a).addClass("calendar").html("<div class=\"calendar-header\">"+"<div class=\"calendar-nav calendar-prevmonth\"></div>"+"<div class=\"calendar-nav calendar-nextmonth\"></div>"+"<div class=\"calendar-nav calendar-prevyear\"></div>"+"<div class=\"calendar-nav calendar-nextyear\"></div>"+"<div class=\"calendar-title\">"+"<span class=\"calendar-text\"></span>"+"</div>"+"</div>"+"<div class=\"calendar-body\">"+"<div class=\"calendar-mymenu\">"+"<div class=\"calendar-mymenu-year-inner\">"+"<span class=\"calendar-nav calendar-mymenu-prev\"></span>"+"<span><input class=\"calendar-mymenu-year\" type=\"text\"></input></span>"+"<span class=\"calendar-nav calendar-mymenu-next\"></span>"+"</div>"+"<div class=\"calendar-mymenu-month-inner\">"+"</div>"+"</div>"+"</div>");
...
var menu=$(_60d).find(".calendar-mymenu");
menu.find(".calendar-mymenu-year").unbind(".calendar").bind("keypress.calendar",function(e){
if(e.keyCode==13){
_60e(true);
}
});
...
var t=_60f(e.target);
if(t.hasClass("calendar-mymenu-next")||t.hasClass("calendar-nextyear")){
_610(1);
}else{
if(t.hasClass("calendar-mymenu-prev")||t.hasClass("calendar-prevyear")){
_610(-1);
}else{
if(t.hasClass("calendar-mymenu-month")){
...
function _60e(_614){
var menu=$(_60d).find(".calendar-mymenu");
var year=menu.find(".calendar-mymenu-year").val();
...
opts.year+=_616;
show(_60d);
menu.find(".calendar-mymenu-year").val(opts.year);
};
function _611(_617){
opts.month+=_617;
if(opts.month>12){
...
$(_618).find(".calendar-mymenu").show();
if($(_618).find(".calendar-mymenu-month-inner").is(":empty")){
$(_618).find(".calendar-mymenu-month-inner").empty();
var t=$("<table class=\"calendar-mtable\"></table>").appendTo($(_618).find(".calendar-mymenu-month-inner"));
var idx=0;
for(var i=0;i<3;i++){
var tr=$("<tr></tr>").appendTo(t);
for(var j=0;j<4;j++){
$("<td class=\"calendar-nav calendar-mymenu-month\"></td>").html(opts.months[idx++]).attr("abbr",idx).appendTo(tr);
}
}
}
var body=$(_618).find(".calendar-body");
var sele=$(_618).find(".calendar-mymenu");
var _619=sele.find(".calendar-mymenu-year-inner");
var _61a=sele.find(".calendar-mymenu-month-inner");
...
_60c(this);
show(this);
$(this).find("div.calendar-mymenu").hide();
});
};
...
if(opts.pagination){
$.extend(_7fa,{pageNo:opts.pageNumber||1,pageSize:opts.pageSize});
}
if(opts.sortName){
$.extend(_7fa,{sortName:opts.sortName,sortOrder:opts.sortOrder});
}
...
var p=$(e.target).closest("span.combo,div.combo-p,div.mymenu");
if(p.length){
_a42(p);
return;
}
...
$(_aa5).combo("setText",vm.join(opts.separator));
}
...
_bd5(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_bea){
...
return $(_bef).datebox("options").cleanText;
},handler:function(_beg) {
$(_beg).combo("setValue", "").combo("setText", "");
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
...
return $(_c0g).datetimebox("options").cleanText;
},handler:function(_c0h) {
$(_c0h).combo("setValue", "").combo("setText", "");
$(_c0h).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
